...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Client](./epubmanager/client.md)<br>
...
By default, this property returns the internal shared client.
 ...
 [Client.HttpClientInstance](./epubmanager/client.md#httpclientinstance) to your own .
