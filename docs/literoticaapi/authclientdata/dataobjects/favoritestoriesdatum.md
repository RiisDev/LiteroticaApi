...
```csharp
public class FavoriteStoriesDatum : System.IEquatable`1[[LiteroticaApi.AuthClientData.DataObjects.FavoriteStoriesDatum, LiteroticaApi, Version=2.1.1.0, Culture=neutral, PublicKeyToken=null]]
```
