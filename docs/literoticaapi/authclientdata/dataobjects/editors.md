...
```csharp
public class Editors : System.IEquatable`1[[LiteroticaApi.AuthClientData.DataObjects.Editors, LiteroticaApi, Version=2.1.1.0, Culture=neutral, PublicKeyToken=null]]
```
