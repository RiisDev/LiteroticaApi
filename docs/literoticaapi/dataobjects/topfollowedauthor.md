...
Implements [IEquatable&lt;TopFollowedAuthor&gt;](https://docs.microsoft.com/en-us/dotnet/api/system.iequatable-1)<br>
...
### **TopFollowedAuthor(TopFollowedAuthor)**

```csharp
protected TopFollowedAuthor(TopFollowedAuthor original)
```

#### Parameters

`original` [TopFollowedAuthor](./literoticaapi/dataobjects/topfollowedauthor.md)<br>
...
### **Equals(TopFollowedAuthor)**

```csharp
public bool Equals(TopFollowedAuthor other)
```

#### Parameters

`other` [TopFollowedAuthor](./literoticaapi/dataobjects/topfollowedauthor.md)<br>
...
```csharp
public TopFollowedAuthor <Clone>$()
```
