...
```csharp
public class X3 : System.IEquatable`1[[LiteroticaApi.DataObjects.X3, LiteroticaApi, Version=2.1.1.0, Culture=neutral, PublicKeyToken=null]]
```
...
### **X3(Nullable&lt;Int64&gt;, Nullable&lt;Int64&gt;, String)**

Represents a high-resolution image asset (x3 scale).

```csharp
public X3(Nullable<long> Width, Nullable<long> Height, string FilePath)
```

#### Parameters

`Width` [Nullable&lt;Int64&gt;](https://docs.microsoft.com/en-us/dotnet/api/system.nullable-1)<br>

`Height` [Nullable&lt;Int64&gt;](https://docs.microsoft.com/en-us/dotnet/api/system.nullable-1)<br>
