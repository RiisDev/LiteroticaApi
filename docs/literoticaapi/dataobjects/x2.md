...
```csharp
public class X2 : System.IEquatable`1[[LiteroticaApi.DataObjects.X2, LiteroticaApi, Version=2.1.1.0, Culture=neutral, PublicKeyToken=null]]
```
...
### **X2(Nullable&lt;Int64&gt;, Nullable&lt;Int64&gt;, String)**

Represents a medium-resolution image asset (x2 scale).

```csharp
public X2(Nullable<long> Width, Nullable<long> Height, string FilePath)
```
