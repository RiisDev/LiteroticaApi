...
```csharp
public class TopCommenters : System.IEquatable`1[[LiteroticaApi.DataObjects.TopCommenters, LiteroticaApi, Version=2.1.1.0, Culture=neutral, PublicKeyToken=null]]
```
