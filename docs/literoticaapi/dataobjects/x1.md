...
```csharp
public class X1 : System.IEquatable`1[[LiteroticaApi.DataObjects.X1, LiteroticaApi, Version=2.1.1.0, Culture=neutral, PublicKeyToken=null]]
```
...
### **X1(Nullable&lt;Int64&gt;, Nullable&lt;Int64&gt;, String)**

Represents a standard image resolution entry (x1 scale).

```csharp
public X1(Nullable<long> Width, Nullable<long> Height, string FilePath)
```
