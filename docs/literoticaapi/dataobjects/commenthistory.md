...
```csharp
public class CommentHistory : System.IEquatable`1[[LiteroticaApi.DataObjects.CommentHistory, LiteroticaApi, Version=2.1.1.0, Culture=neutral, PublicKeyToken=null]]
```
